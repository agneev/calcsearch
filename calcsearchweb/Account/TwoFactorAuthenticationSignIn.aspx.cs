...
namespace calcsearchweb.Account
{
    public partial class TwoFactorAuthenticationSignIn : System.Web.UI.Page
    {
        ...
        protected void Page_Load(string sender, EventArgs e)
        {
        ...
        protected void CodeSubmit_Click(string sender, EventArgs e)
        {
        ...
        protected void ProviderSubmit_Click(string sender, EventArgs e)
        {
